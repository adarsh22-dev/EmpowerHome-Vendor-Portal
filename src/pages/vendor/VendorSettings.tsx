...
const FormRow = ({ label, required, hint, children, vertical = false }: { label: string, required?: boolean, hint?: string, children: React.ReactNode, vertical?: boolean, key?: any }) => (
...
const ImageUpload = ({ value, onChange, sublabel }: { value: string | null, onChange: (val: string) => void, label?: string, sublabel?: string }) => {
    ...
    return (
        <div className="vs-upload-container">
            <div className="vs-upload-box" onClick={() => fileRef.current?.click()}>
                {value ? <img src={value} alt="upload" className="vs-preview" referrerPolicy="no-referrer" /> : 
...
const VendorSettings = () => {
    ...
    const updateField = (tab: string, field: string, value: any) => {
    ...
    const updateBankDetail = (field: string, value: any) => {
        setFormData((prev: any) => ({
            ...prev,
            payment: {
                ...prev.payment,
                                ...
                                <div key={day} className="vs-hours-row-card">
                                    ...
                                    <div className="vs-slots-flex">
                                        <div className="vs-slot-input">
                                            <label>Opening</label>
                                            <input type="time" value={(formData.hours.slots as any)[day].open} onChange={e => {
                                                const newSlots = { ...formData.hours.slots, [day]: { ...(formData.hours.slots as any)[day], open: e.target.value } };
                                                setFormData({ ...formData, hours: { ...formData.hours, slots: newSlots } });
                                            }} />
                                        </div>
                                        <div className="vs-slot-input">
                                            <label>Closing</label>
                                            <input type="time" value={(formData.hours.slots as any)[day].close} onChange={e => {
                                                const newSlots = { ...formData.hours.slots, [day]: { ...(formData.hours.slots as any)[day], close: e.target.value } };
                                                setFormData({ ...formData, hours: { ...formData.hours, slots: newSlots } });
                                            }} />
                                        </div>
                                    </div>
    ...
    return (
        <VendorLayout title="Vendor Settings">
