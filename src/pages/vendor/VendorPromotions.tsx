...
const VendorPromotions = ({ onCreate }: { onCreate?: () => void }) => {
    ...
    return (
        <VendorLayout title="Promotions & Discounts">
            <div className="vendor-promotions-container">
                ...
                <div className="promo-header-row">
                    ...
                    <button className="btn-create-promo" onClick={() => onCreate ? onCreate() : navigate('/vendor/promotions/create')}>
                        <Plus size={18} />
